...
import { Search, ChevronDown, Home, UserMultiple, Settings, Send } from "@carbon/icons-react";
...
const navItems: NavItem[] = [
  ...
  { label: "Transactions", icon: <PricingQuickProposal size={16} />, href: "/transactions", active: true },
    ...
    <div className="flex h-screen bg-[var(--background-secondary)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 flex flex-col overflow-auto p-[var(--padding-3xl)] bg-[var(--background-primary)] m-[var(--padding-xl)] rounded-[var(--radius-lg)]">
          <Breadcrumbs items={[{ label: "", icon: <PricingQuickProposal size={16} /> }, { label: "Transactions" }]} className="mb-[var(--padding-2xl)]" />
